		...
		BeaconState struct {
			Value struct {
				...
				CurrentCrosslinks      []struct {
					...
					ParentRoot []byte `json:"parent_root" ssz:"size=32"`
					DataRoot   []byte `json:"data_root" ssz:"size=32"`
				} `json:"current_crosslinks" ssz:"size=1024"`
				PreviousCrosslinks []struct {
					...
					ParentRoot []byte `json:"parent_root" ssz:"size=32"`
					DataRoot   []byte `json:"data_root" ssz:"size=32"`
				} `json:"previous_crosslinks" ssz:"size=1024"`
...
type SszMainnetBeaconState struct {
	Value      MainnetState `json:"value"`
	Serialized []byte       `json:"serialized"`
	Root       []byte       `json:"root" ssz:"size=32"`
}
